...
exports.printFilter = function (filter, type) {
    ...
    var field = utils_1.root.rgo.schema[type][filter[0]];
...
exports.parseFilter = function (filter, type) {
    try {
        return parseFilterValues(parser(filter.replace(/OR/g, '|')), __assign({}, utils_1.root.rgo.schema[type], { id: { scalar: 'string', meta: { name: 'id' } } }));
    }
    catch (error) {
        return null;
    }
