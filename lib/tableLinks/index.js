...
exports.default = mishmash_1.default
    ...
    return ({
        style: {
            base: style,
            spinner: style_transform_1.default(style).mergeKeys('spinner'),
            header: style_transform_1.default(style).mergeKeys('header'),
            columnCell: (_a = style_transform_1.default(style)
            ...
            columnText: (_b = style_transform_1.default(style)
                .mergeKeys('column')).filter.apply(_b, __spread(elmnt_1.css.groups.text)),
            link: style_transform_1.default(style)
                .mergeKeys('link')
                .merge({ position: 'relative' }),
            filter: style_transform_1.default(style).mergeKeys('filter'),
        },
    });
    var _a, _b;
})
    .merge(function (_, push) { return ({
    filter: null,
    ...
    .merge('rows', 'data', function (rows, data) {
