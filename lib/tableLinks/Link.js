...
exports.default = mishmash_1.compose(mishmash_1.withHover, mishmash_1.map(mishmash_1.restyle(['isHovered'], function (isHovered) { return [['mergeKeys', { hover: isHovered }]]; }), mishmash_1.restyle({
    cell: [
    ...
    index: [['mergeKeys', 'index'], __spread(['filter'], elmnt_1.css.groups.text)],
})))(function (_a) {
