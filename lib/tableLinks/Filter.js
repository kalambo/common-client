...
var Help = mishmash_1.default.merge('style', function (style) { return ({
    style: {
        base: style,
        title: style_transform_1.default(style).mergeKeys('title'),
        subtitle: style_transform_1.default(style).mergeKeys('title'),
        text: style_transform_1.default(style).mergeKeys('text'),
        indent: style_transform_1.default(style).mergeKeys('indent'),
        note: style_transform_1.default(style).mergeKeys('note'),
        op: style_transform_1.default(style).mergeKeys('op'),
        fields: style_transform_1.default(style).mergeKeys('fields'),
    },
}); })(function (_a) {
...
exports.default = mishmash_1.default
    ...
    style: {
        label: style_transform_1.default(style).mergeKeys('label'),
        helpLabel: style_transform_1.default(style).mergeKeys('helpLabel'),
        field: style_transform_1.default(style).mergeKeys('field'),
        help: style_transform_1.default(style).mergeKeys('help'),
    },
}); })
    ...
    push({
        schemaLoaded: false,
        isOpen: false,
        toggleIsOpen: function () { return push(function (_a) {
            var isOpen = _a.isOpen;
            return ({ isOpen: !isOpen });
        }); },
    });
    var mounted = true;
    common_1.root.rgo.query().then(function () { return mounted && push({ schemaLoaded: true }); });
    return function () { return (mounted = false); };
})
    .merge('type', 'onChange', function (type, onChange, push) {
    ...
    .do(mishmash_1.yieldLifted('bounds', 'setBoundsElem', function (_a) {
    var type = _a.type, toggleOpen = _a.toggleOpen, style = _a.style;
