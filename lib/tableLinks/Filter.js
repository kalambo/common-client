...
var Help = mishmash_1.default().style({
    base: null,
...
exports.default = mishmash_1.default()
    ...
    var onChangeBase = firstProps.onChange;
    ...
    var toggleIsOpen = function () { return setState(function (_a) {
    ...
    .merge(mishmash_1.renderLifted(function (_a) {
    var type = _a.type, toggleOpen = _a.toggleOpen, style = _a.style;
