...
exports.default = mishmash_1.compose(mishmash_1.map(mishmash_1.restyle({
    ...
    return (React.createElement(elmnt_1.Div, { style: {
        ...
        React.createElement(mishmash_1.Wrap, { hoc: mishmash_1.withHover }, function (_a) {
            ...
            return (React.createElement(elmnt_1.Txt, __assign({ onClick: toggleOpen }, hoverProps, { style: style_transform_1.default(__assign({}, style.helpLabel, { cursor: 'pointer', textAlign: 'right' }), [['mergeKeys', { hover: hover }]]) }), "Open help"));
        })));
});
