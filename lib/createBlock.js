...
exports.default = (function (blockProps, blockHOC, style, admin, fieldHOC) {
    ...
    return [
        ...
        mishmash_1.compose(blockHOC, mishmash_1.map(function (_a) {
            ...
            var text = _a.text, prompt = _a.prompt, vertical = _a.vertical, view = _a.view, fields = _a.fields, next = _a.next;
            return text ? (React.createElement(elmnt_1.Div, { style: { spacing: 10 } }, vertical ? (React.createElement(elmnt_1.Div, { style: { spacing: 10 } },
                ...
                next())) : (React.createElement(elmnt_1.Div, { style: {
                    layout: 'bar',
                    width: '100%',
                    verticalAlign: 'top',
                    spacing: 30,
