...
var Hover = mishmash_1.default()
    ...
    .toComp();
exports.routerPure = mishmash_1.default()
    .merge(react_router_dom_1.withRouter)
    .pure();
exports.withRouter = function (basename) {
    return mishmash_1.default()
        ...
        .map(mishmash_1.omit('setBreadcrumb', 'match', 'history'));
};
var RouteComponent = mishmash_1.default().branch(function (_a) {
...
var Breadcrumb = mishmash_1.default()
    ...
    .enhance(function (_a) {
    var firstProps = _a.firstProps, onProps = _a.onProps;
...
exports.Breadcrumbs = mishmash_1.default().style({
    base: null,
    link: [['mergeKeys', 'link']],
