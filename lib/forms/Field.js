...
exports.default = (function (fileServer) {
    var FileButton = mishmash_1.default
        ...
        .map(mishmash_1.restyle([['mergeKeys', 'button'], ['merge', { width: '100%' }]]))(function (_a) {
    ...
    return mishmash_1.default
        ...
        return (__assign({}, props, { value: (value && value[props.index]) || null, onChange: function (indexValue) {
                var newValue = __spread(__spread(new Array(props.index)).map(function (_, i) {
                    return common_1.noUndef(value && value[i]);
                }), [
                    indexValue
                ], (value || []).slice(props.index + 1).map(common_1.noUndef));
        ...
        .map(mishmash_1.restyle([__spread(['filter'], elmnt_1.css.groups.text)]))
        .render(function (_a) {
        ...
        .stream(function (_a) {
        var initial = _a.initial, push = _a.push;
        return push({
            otherOpen: initial.value !== null &&
                !initial.options.includes(initial.value),
        }) ||
            (function (props, state) { return (__assign({}, props, state, { onBaseChange: function (value) {
