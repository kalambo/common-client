...
exports.default = (function (fileServer) {
    var FileButton = refluent_1.default
        ...
        .do(utils_1.restyle(function (style) { return style.mergeKeys('button').merge({ width: '100%' }); }))
        .yield(function (_a) {
    ...
    return refluent_1.default
        ...
        .yield(utils_1.branch('view', refluent_1.default
        .do(utils_1.restyle(function (style) { return style.filter.apply(style, __spread(elmnt_1.css.groups.text)); }))
        .yield(function (_a) {
        ...
        .yield(utils_1.branch('relation', refluent_1.default
        ...
        .yield(utils_1.branch('other', refluent_1.default
