...
var Question = mishmash_1.default().style([
    ['mergeKeys', 'question'],
    __spread(['filter'], elmnt_1.css.groups.text),
])(elmnt_1.Txt);
var Prompt = mishmash_1.default().style([
    ['mergeKeys', 'prompt'],
    __spread(['filter'], elmnt_1.css.groups.text),
])(elmnt_1.Txt);
var Vertical = mishmash_1.default()
    .style(['view', 'small'], function (view, small) { return [
    [
        'scale',
        {
            paddingTop: view
    ...
    .map(mishmash_1.omit('view', 'small'))(elmnt_1.Div);
