...
var Question = mishmash_1.default.merge('style', function (style) {
    return ({
        style: (_a = style_transform_1.default(style)
            .mergeKeys('question')).filter.apply(_a, __spread(elmnt_1.css.groups.text)),
    });
    var _a;
})(elmnt_1.Txt);
var Prompt = mishmash_1.default.merge('style', function (style) {
    return ({
        style: (_a = style_transform_1.default(style)
            .mergeKeys('prompt')).filter.apply(_a, __spread(elmnt_1.css.groups.text)),
    });
    var _a;
})(elmnt_1.Txt);
var Vertical = mishmash_1.default.merge('style', 'view', 'small', function (style, view, small) { return ({
