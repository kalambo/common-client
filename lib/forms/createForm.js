...
exports.default = (function (container, blockProps, blockHOC, fieldHOC, style, admin) {
    ...
    var RowField = mishmash_1.default()
        .style(['alt'], function (alt) { return [['mergeKeys', { alt: alt }]]; })
        .map(mishmash_1.omit('alt'))(Field);
    return createForm_1.default(container, __spread(blockProps, ['text', 'prompt', 'vertical', 'connect', 'columns', 'view']), mishmash_1.default()
        .merge(blockHOC)
        .map(function (_a) {
