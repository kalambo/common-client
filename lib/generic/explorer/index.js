...
exports.default = mishmash_1.default
    ...
    style: {
        base: style_transform_1.default(style)
        ...
        footer: style_transform_1.default(style).scale({
            height: {
                fontSize: 1,
                paddingTop: 1,
                paddingBottom: 1,
    ...
    props$('config', 'types', 'meta', 'editable', 'input', 'permalink', 'fileServer', 'reset', 'style', function (config, types, meta, editable, input, permalink, fileServer, reset, style) {
        if (meta === void 0) { meta = {}; }
        return ({
            context: {
                config: config,
