...
exports.default = (function (initial, onUpdate) {
    var query = initial && JSON.parse(JSON.stringify(initial));
    onUpdate(query);
    return {
        ...
        add: function (path, type, field) {
            ...
            var parent = splitPath
                .slice(0, -1)
                .reduce(function (res, i) { return res.fields[i]; }, { fields: query });
            parent.fields.splice(index, 0, field === 'id' || (type && rgo_1.fieldIs.scalar(common_1.root.rgo.schema[type][field]))
                ? field
                : { name: field, end: 100, fields: [] });
            onUpdate(query, path);
        },
