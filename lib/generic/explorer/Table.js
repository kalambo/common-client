...
exports.default = mishmash_1.default
    ...
    initial.context.store.watch(function (props) { return "table_" + props.index + "_width"; }, function (width) {
    ...
    return function (props, state) { return (__assign({}, props, state, { setNoScrollElem: setNoScrollElem, setSizeElem: function (elem) {
            props.setHeightElem(elem);
            props.context.setWidthElem("table_" + props.index + "_width", elem);
        } })); };
})
    .cache('setSizeElem')(function (_a) {
