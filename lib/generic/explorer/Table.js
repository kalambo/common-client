...
exports.default = refluent_1.default
    ...
    .do('context', 'index', 'setHeightElem', function (context, index, setHeightElem) { return ({
    setSizeElem: Object.assign(function (elem) {
        setHeightElem(elem);
    ...
    return {
        setNoScrollElem: Object.assign(function (e) {
            if (elem)
