...
exports.default = mishmash_1.default()
    ...
    .style(['name', 'path', 'span', 'firstCol', 'lastCol'], function (name, path, span, firstCol, lastCol) { return ({
    base: null,
    td: [
        [
            'scale',
    ...
    firstProps.context.store.watch(function (props) { return props.path + "_" + props.name + "_width"; }, function (width) { return setState({ width: width }); }, onProps, firstProps);
    ...
    return (React.createElement("td", { style: __assign({}, style.td, (live && !span ? { minWidth: width } : {})), colSpan: span || 1, rowSpan: rowSpan, ref: !span ? setWidthElem : undefined },
        live && (React.createElement("div", { style: style.fill },
            ...
            name === '#1' && (React.createElement(PageField_1.default, { up: true, context: context, path: path, active: isPathPageUp, style: style })),
            name === '#1' && (React.createElement(PageField_1.default, { context: context, path: path, active: isPathPageDown, style: style })))),
        name === '#1' && (React.createElement(LimitField_1.default, { context: context, live: live, path: path, active: isPathLimit, focused: isPathLimit && focused, style: style })),
