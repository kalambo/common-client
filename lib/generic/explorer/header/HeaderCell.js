...
exports.default = mishmash_1.default
    .pure()
    .merge('style', 'alt', function (props) { return props.name === ''; }, function (props) { return props.isPathSort || props.isSiblingSort; }, function (props) { return props.isPathRemove || props.isChildRemove; }, function (props) {
...
}, function (style, alt, empty, sort, remove, active) { return ({
    style: style_transform_1.default(style).mergeKeys({
        header: true,
        alt: alt,
        empty: empty,
        sort: sort,
    ...
    .merge('style', 'name', 'path', 'span', 'firstCol', 'lastCol', function (style, name, path, span, firstCol, lastCol) {
    return ({
        style: {
            base: style,
            td: style_transform_1.default(style)
            ...
            fill: style_transform_1.default(style)
                .scale({
            ...
            icon: (_a = style_transform_1.default(style)
            ...
            text: (_b = style_transform_1.default(style)).filter.apply(_b, __spread(elmnt_1.css.groups.text)).merge({
                cursor: 'default',
                position: 'relative',
                userSelect: 'none',
                MozUserSelect: 'none',
    ...
    .merge('context', 'live', function (_a) {
