...
var Item = mishmash_1.default()
    ...
    return function (props) { return (__assign({}, props, methods({ onClick: function () { return props.onClick(props.field); } }))); };
})
    .enhance(mishmash_1.watchHover)
    .style(['relation', 'isHovered'], function (relation, isHovered) { return [
...
exports.default = mishmash_1.default()
    ...
    return function (_a) {
        ...
        return (__assign({}, props, methods({
            onMouseMove: function () { return props.context.setActive({ type: 'add', path: path }); },
            onMouseLeave: function () { return props.context.setActive(null); },
            onClick: function () { return props.context.setActive({ type: 'add', path: path }, true); },
    ...
    .enhance(mishmash_1.onClickOutside(function (props) {
    if (props.focused) {
        props.context.setActive(null, true);
        return true;
    }
}, 'setClickElem'))
    .merge(mishmash_1.renderLifted(mishmash_1.fitScreen(function (_a) {
