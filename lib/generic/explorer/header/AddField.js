...
exports.default = refluent_1.default
    ...
    return (React.createElement(elmnt_1.Modal, { isOpen: focused, onClose: onModalClose, getBase: function (_a) {
        ...
        React.createElement(elmnt_1.Div, { style: style.modal }, (type
            ...
            : Object.keys(context.types).sort()).map(function (f, i) { return (React.createElement(Item, { context: context, type: type, field: f, relation: f !== 'id' && (!type || utils_1.root.rgo.schema[type][f].type), onClick: onClickItem, style: style.base, key: i })); }))));
})
    .yield(function (_a) {
