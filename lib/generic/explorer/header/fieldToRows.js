        ...
        : fields.reduce(function (rows, f, i) {
            ...
            if (typeof f === 'string') {
                rows[0].push({
                    name: f,
                    type: type,
                    isList: f !== 'id' && utils_1.root.rgo.schema[type][f].isList,
                    path: newPath,
                    ...
                    text: context.types[type].fields.find(function (x) { return x[0] === f; })[1],
                });
                return rows;
            }
            var newType = type
            ...
            var fieldSchema = type && utils_1.root.rgo.schema[type][f.name];
            rows[0].push({
                name: '#1',
                type: type,
                isList: !fieldSchema ||
                ...
                text: type
                    ? context.types[type].fields.find(function (x) { return x[0] === f.name; })[1]
