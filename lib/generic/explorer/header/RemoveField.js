...
exports.default = mishmash_1.default
    ...
    return (__assign({}, props, { onMouseMove: function () { return props.context.setActive({ type: 'remove', path: path }); }, onMouseLeave: function () { return props.context.setActive(null); }, onClick: function () {
