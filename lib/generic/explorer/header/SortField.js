...
exports.default = mishmash_1.default().enhance(function (_a) {
    var methods = _a.methods;
    return function (_a) {
        var path = _a.path, props = __rest(_a, ["path"]);
        return (__assign({}, props, methods({
            onMouseMove: function () { return props.context.setActive({ type: 'sort', path: path }); },
            onMouseLeave: function () { return props.context.setActive(null); },
            onClick: function () { return props.context.query.sort(path); },
        })));
    };
})(function (_a) {
