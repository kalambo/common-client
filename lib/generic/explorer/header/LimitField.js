...
exports.default = mishmash_1.default
    ...
    initial.context.store.watch(function (props) { return props.path + "_start"; }, function (start) {
        if (start === void 0) { start = 1; }
        return push({ start: start });
    }, observe, initial);
    initial.context.store.watch(function (props) { return props.path + "_end"; }, function (end) {
    ...
    return function (props, _a) {
        ...
        return __assign({}, props, { start: start,
            ...
            invalid: invalid, onChangeStart: function (v) {
    ...
    .cache('onChangeStart', 'onChangeEnd', 'onMouseMove', 'onMouseLeave', 'onClick', 'onClickOutside', 'onKeyDown')
    ...
    .map(mishmash_1.restyle(['active', 'focused'], function (active, focused) { return ({
    input: {
        div: [
