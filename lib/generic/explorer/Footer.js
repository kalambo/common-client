...
exports.default = mishmash_1.default
    ...
    initial.context.store.watch('unchanged', function (unchanged) {
        ...
        return push({ editing: Object.keys(unchanged).length > 0 });
    }, observe);
    var clear = function () {
        (_a = common_1.root.rgo).set.apply(_a, __spread(Object.keys(initial.context.store.get('unchanged') || {}).map(function (k) { return ({
            key: k.split('.'),
            value: undefined,
        }); })));
    ...
    return function (props, state) { return (__assign({}, props, state, { save: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (_a = common_1.root.rgo).commit.apply(_a, __spread(Object.keys(initial.context.store.get('unchanged') || {}).map(function (k) { return k.split('.'); })))];
                    case 1:
                        _b.sent();
                        initial.context.store.set('unchanged', {});
                        return [3 /*break*/, 3];
