...
var Link = mishmash_1.default.do(mishmash_1.watchHover).map(mishmash_1.restyle(['isHovered'], function (isHovered) { return [
...
var Button = mishmash_1.default
    ...
    .map(mishmash_1.restyle(['isHovered', 'save'], function (isHovered, save) { return [
...
exports.default = mishmash_1.default
    ...
    initial.context.store.watch('initial', function (initial) {
        if (initial === void 0) { initial = {}; }
        return push({ editing: Object.keys(initial).length > 0 });
    }, observe);
    var clear = function () {
        (_a = common_1.root.rgo).set.apply(_a, __spread(Object.keys(initial.context.store.get('initial') || {}).map(function (k) { return ({
            key: k.split('.'),
            value: undefined,
        }); })));
    ...
    return function (props, state) { return (__assign({}, props, state, { save: function () { return __awaiter(_this, void 0, void 0, function () {
            var error_1, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (_a = common_1.root.rgo).commit.apply(_a, __spread(Object.keys(initial.context.store.get('initial') || {}).map(function (k) {
                                return k.split('.');
                            })))];
                    case 1:
                        _b.sent();
        ...
        }); }, clear: clear, reset: function () {
            clear();
            initial.context.reset();
        }, permalink: function () {
            window.open(initial.context.permalink + "?" + jsonUrl_1.default.stringify(props.linkQuery));
        }, download: function () {
            download_1.default(props.context.config, props.context.types, props.query, props.data);
        } })); };
})
    .cache('save', 'clear', 'reset', 'permalink', 'download')(function (_a) {
