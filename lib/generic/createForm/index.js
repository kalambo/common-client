...
var mapProps = function (map) { return function (C) { return function (props) { return React.createElement(C, map(props)); }; }; };
function createForm(container, blockProps, block) {
    var _this = this;
    var Block = mishmash_1.default.doIf('fields', mishmash_1.default
        .do(getState_1.default)
        .doIf(function (_a) {
        var state = _a.state;
        return !state;
    }, mishmash_1.default.yield(function () { return null; }))
        .merge('stores', 'fields', 'state', function (stores, fields, state) { return ({
        ...
        stores: undefined,
        state: undefined,
    }); }), mishmash_1.default.merge({ fields: undefined, stores: undefined, state: undefined }))(block);
    return mishmash_1.default
        .pure(true)
        .do(mapProps(function (_a) {
        ...
        var count = 0;
        props$('objects', 'blocks', function (objects, blocks) {
            setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            index = ++count;
                            return [4 /*yield*/, prepareFields_1.default(blockProps, objects, blocks, stores)];
                        case 1:
                            info = _a.sent();
                            if (index === count)
                                push(info);
            ...
            return function () {
                (_a = common_1.root.rgo).set.apply(_a, __spread((props$().$fields || [])
        ...
        .doIf('fields', mishmash_1.default
        .merge(function (_, push) {
        var mounted = true;
        push({
            processing: null,
        ...
        .do(getState_1.default)
        .doIf('state', mishmash_1.default.merge(function (props$) {
        var submit = function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, onCommit, onSubmit, onError, stores, objects, fields, state, lockHeight, setProcessing, visibleFields, values, rgoKeys_1, extra_1, extraValues, changes_1, newIds, _b, _c, obj, _d, type, id, _e, _f, _g, _h, _j, e_1, _k;
            return __generator(this, function (_l) {
                switch (_l.label) {
                    case 0:
                        _a = props$(), onCommit = _a.onCommit, onSubmit = _a.onSubmit, onError = _a.onError, stores = _a.stores, objects = _a.objects, fields = _a.fields, state = _a.state, lockHeight = _a.lockHeight, setProcessing = _a.setProcessing;
                    ...
                    case 1:
                        ...
                        (_h = common_1.root.rgo).set.apply(_h, __spread(extraValues.map(function (_a) {
                    ...
                    case 2:
                        _l.trys.push([2, 6, , 9]);
                        return [4 /*yield*/, (_j = common_1.root.rgo).commit.apply(_j, __spread(rgoKeys_1.map(function (key) { return key.key; })))];
                    case 3:
                        newIds = _l.sent();
                        try {
                            for (_b = __values(Object.keys(objects)), _c = _b.next(); !_c.done; _c = _b.next()) {
                                obj = _c.value;
                                _d = objects[obj], type = _d.type, id = _d.id;
