...
function getData() {
    ...
    return mishmash_1.combineState(function (_a) {
        ...
        if (typeof queries[0] !== 'function') {
            unsubscribe = (_b = common_1.root.rgo).query.apply(_b, __spread(queries, [function (data) { return setState({ data: data }); }]));
        }
        else {
            var prevJSON_1;
            var update = function (props) {
                ...
                if (nextJSON !== prevJSON_1) {
                    ...
                    unsubscribe = (_a = common_1.root.rgo).query.apply(_a, __spread(q, [function (data) { return setState({ data: data }); }]));
                }
                prevJSON_1 = nextJSON;
                var _a;
            };
        ...
        onUnmount(function () { return unsubscribe(); });
