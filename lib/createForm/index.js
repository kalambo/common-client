...
function createForm(container, block) {
    var _this = this;
    var Block = mishmash_1.branch(function (_c) {
        var fields = _c.fields;
        return fields;
    }, mishmash_1.compose(getState_1.default, mishmash_1.branch(function (_c) {
        var state = _c.state;
        return !state;
    }, mishmash_1.render()), mishmash_1.map(function (_c) {
    ...
    })), mishmash_1.map(mishmash_1.omit('fields', 'stores', 'state')))(Array.isArray(block) ? block[1] : block);
    return mishmash_1.compose(mishmash_1.map(function (_c) {
    ...
    }), mishmash_1.pure, mishmash_1.enclose(function (_c) {
        var initialProps = _c.initialProps, onProps = _c.onProps, setState = _c.setState;
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        index = ++count;
                        return [4 /*yield*/, prepareFields_1.default(Array.isArray(block) ? block[0] : [], props.objects, props.blocks, stores)];
                    case 1:
                        info = _d.sent();
                        if (index === count) {
                            fields = info.fields;
    ...
    }, { info: {} }), mishmash_1.enclose(function (_c) {
        var setState = _c.setState;
        var setElem = function (elem) { return setState({ elem: elem }); };
        var HeightWrap = function (_c) {
            var children = _c.children;
            return (React.createElement("div", { ref: setElem }, children));
        };
        var setHeight = function (height) { return setState({ height: height }); };
        return function (props, state) { return (__assign({}, props, state, { HeightWrap: HeightWrap,
            setHeight: setHeight })); };
    }, { elem: null, height: null }), mishmash_1.branch(function (_c) {
        var fields = _c.fields;
        return fields;
    }, mishmash_1.compose(mishmash_1.enclose(function (_c) {
    ...
    }, { processing: null }), getState_1.default, mishmash_1.branch(function (_c) {
        var state = _c.state;
        return state;
    }, mishmash_1.enclose(function () {
        var methods = mishmash_1.methodWrap();
        return function (_c) {
            var onCommit = _c.onCommit, onSubmit = _c.onSubmit, onError = _c.onError, elem = _c.elem, setHeight = _c.setHeight, setProcessing = _c.setProcessing, props = __rest(_c, ["onCommit", "onSubmit", "onError", "elem", "setHeight", "setProcessing"]);
    ...
    }), mishmash_1.pure, mishmash_1.map(function (_c) {
