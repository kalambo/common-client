...
function createForm(container, block) {
    ...
    return recompose_1.compose(mishmash_1.memoizeProps('objects', 'blocks'), recompose_1.pure, mishmash_1.mapPropsStream(function (props$) {
        ...
        var stores = {
            rgo: {
                get: function (keys, emit) {
                    ...
                    return (_a = common_1.root.rgo).query.apply(_a, __spread(queryKeys.map(function (key, i) { return ({
                        name: key.split('.')[0],
                        alias: "obj" + i,
                        filter: key.split('.')[1],
                ...
                set: function (values) {
                    (_a = common_1.root.rgo).set.apply(_a, __spread(values));
                    var _a;
                },
            },
            local: {
        ...
        props$.observe(function () { }).then(function () {
            (_a = common_1.root.rgo).set.apply(_a, __spread(fields
                ...
                return __generator(this, function (_k) {
                    switch (_k.label) {
                        ...
                        case 1:
                            ...
                            (_g = common_1.root.rgo).set.apply(_g, __spread(extraValues.map(function (_a) {
                                var key = _a.key, value = _a.value;
                                return ({
                                    key: key.key,
                                    value: value,
                        ...
                        case 2:
                            _k.trys.push([2, 6, , 9]);
                            return [4 /*yield*/, (_h = common_1.root.rgo).commit.apply(_h, __spread(rgoKeys_1.map(function (key) { return key.key; })))];
                        case 3:
                            newIds = _k.sent();
                            try {
