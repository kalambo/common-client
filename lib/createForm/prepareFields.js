...
exports.default = function (blockProps, objects, blocks, stores) {
    if (objects === void 0) { objects = {}; }
    return __awaiter(_this, void 0, void 0, function () {
        var objectKeys, response, getInitialValue, allFields, mappedBlocks, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    objectKeys = Object.keys(objects);
                    return [4 /*yield*/, (_a = window.rgo).query.apply(_a, __spread(objectKeys.filter(function (obj) { return objects[obj].filter; }).map(function (obj) { return ({
                ...
                case 1:
                    ...
                    getInitialValue = function (_a, value) {
                        ...
                        return window.rgo.schema[type][f].type
                    ...
                    mappedBlocks = blocks.map(function (blockSet) {
                        return blockSet.map(function (_a) {
                            ...
                            var blockFields = (fields
                                ? fields.map(function (f) { return (__assign({}, f, config.field)); })
